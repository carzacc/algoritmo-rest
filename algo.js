...
let partite = function (giornata) {
    ...
    let finoundicesima = false;
    let finododicesima = false;
    let finotredicesima = false;
    let finoquattordicesima = false;
    let finoquindicesima = false;
    let finosedicesima = false;
    if (giornata < 5)
        soloquarta = true;
    if (giornata < 6)
        finoquinta = true;
